...
// Editing each rows
  ...
  return (
    <>
      ...
      <button className= "bg-[#A53573] text-white font-bold py-2 px-8 rounded shadow border-2 border-[#A53573] hover:bg-transparent hover:text-[#A53573] transition-all duration-300 my-5"type='submit'>{isEditing ? "Editing Item" : "Add Table Item"}</button>
      </form>
